...
describe("Add a player", function () {
    it("should add a player in Players", function () {
        var oldNumPlayers = Players.find().count();  
        $("form input").val("Jesus");
        $("form input").click();
        var newNumPlayers = Players.find().count(); 
        //numero de usuarios nuevo igual al viejo +1
        expect(newNumPlayers).toEqual(oldNumPlayers+1);
    });
});
...
describe("Point Assignment", function () {
  ...
  it("should give a player 5 points when he is selected and the button is pressed", function () {
    ...
    it("should take off a player 5 points when he is selected and the take off's button is pressed", function () {
    var graceInitialPoints = Players.findOne({name: "Grace Hopper"}).score;
...
describe("Selecting Grace Hopper", function () {
  ...
  it("should remove Grace Hopper", function () {
    ...
    var gh = Players.findOne({name: "Grace Hopper"})
